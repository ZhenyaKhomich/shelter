const pets = [
    {
      name: "Katrine",
      img: "../assets/img/size500/katrine.png",
      type: "Cat",
    ...
    {
      name: "Jennifer",
      img: "../assets/img/size500/jennifer.png",
      type: "Dog",
      breed: "Labrador",
    ...
    {
      name: "Woody",
      img: "../assets/img/size500/woody.png",
      type: "Dog",
    ...
    {
      name: "Sophia",
      img: "../assets/img/size500/sophia.png",
      type: "Dog",
      breed: "Shih tzu",
    ...
    {
      name: "Timmy",
      img: "../assets/img/size500/timmy.png",
      type: "Cat",
      breed: "British Shorthair",
    ...
    {
      name: "Charly",
      img: "../assets/img/size500/charly.png",
      type: "Dog",
    ...
    {
      name: "Scarlett",
      img: "../assets/img/size500/scarlett.png",
      type: "Dog",
      breed: "Jack Russell Terrier",
    ...
    {
      name: "Freddie",
      img: "../assets/img/size500/freddie.png",
      type: "Cat",
      breed: "British Shorthair",
